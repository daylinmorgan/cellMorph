...
imSeg = np.load(
    "../data/TJ2201/segmentedIms/composite_D2_4_2022y04m08d_08h00m_seg.npy",
    allow_pickle=True,
)
imSeg = imSeg.item()
...
imNum = 9
im = imread(
    f"../data/TJ2201Split16/phaseContrast/phaseContrast_E2_4_2022y04m07d_16h00m_{imNum}.png"
)
cellMorphHelper.viewPredictorResult(
    predictorTJ2201Split,
    f"../data/TJ2201Split16/phaseContrast/phaseContrast_E2_4_2022y04m07d_16h00m_{imNum}.png",
)
cellMorphHelper.viewPredictorResult(
    predictorAG2021,
