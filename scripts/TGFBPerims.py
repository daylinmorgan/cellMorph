...
TGFB10esamNeg = pickle.load(
    open(os.path.join(resDir, "AG2217-ESAM-TGFB-B4.pickle"), "rb")
)
esamPos = pickle.load(open(os.path.join(resDir, "AG2217-ESAM-TGFB-B9.pickle"), "rb"))
TGFB10esamPos = pickle.load(
    open(os.path.join(resDir, "AG2217-ESAM-TGFB-B11.pickle"), "rb")
)
coculture = pickle.load(open(os.path.join(resDir, "AG2217-ESAM-TGFB-B5.pickle"), "rb"))
TGFB10coculture = pickle.load(
    open(os.path.join(resDir, "AG2217-ESAM-TGFB-B6.pickle"), "rb")
)
...
allLabels = (
    ["esamNeg" for x in range(len(esamNeg))]
