...
coculture = [
    cell for cell in coculture if cell.date < datetime.datetime(2022, 4, 8, 16, 0)
]
# Filter color
...
labels = (
    [
        "Coculture ESAM +" if x.color == "red" else "Coculture ESAM -"
        for x in cocultureSub
    ]
...
X_train, X_test, y_train, y_test = train_test_split(
    XMono, yMono, test_size=0.33, random_state=1234
)
