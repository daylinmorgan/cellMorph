...
# %%
esamNeg = cellMorphHelper.filterCells(
    esamNeg, confluencyDate=datetime.datetime(2022, 4, 8, 16, 0), color="red", edge=True
)
esampos = cellMorphHelper.filterCells(
    esamNeg,
    confluencyDate=datetime.datetime(2022, 4, 8, 16, 0),
    color="green",
    edge=True,
)
